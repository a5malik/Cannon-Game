package tipcalculator.deitel.com.tipcalculator;
...
public class MainActivity extends Activity {
    ...
    {
        tip15TextView.setText(currencyFormat.format(0.15 * billAmount));
        total15TextView.setText(currencyFormat.format(1.15 * billAmount));
    }

    private void updateCustom()
    {
        percentCustomTextView.setText(percentFormat.format(customPercent));
        tipCustomTextView.setText(currencyFormat.format(customPercent* billAmount));
        totalCustomTextView.setText(currencyFormat.format((1+customPercent)*billAmount));
    }
